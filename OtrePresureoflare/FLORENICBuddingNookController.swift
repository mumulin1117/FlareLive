...
class FLORENICBuddingNookController: UIViewController {
    ...
    private lazy var FLORENIClogoImageView: UIImageView = {
        ...
        FLORENICimageView.image = FLORENICResourceLoader.shared.FLORENICImage(named: "FLORENICbiodegradable")
    ...
    private lazy var FLORENICactionButton: UIButton = {
        ...
        FLORENICbutton.setImage(FLORENICResourceLoader.shared.FLORENICImage(named: "FLORENICweaving"), for: .normal)
